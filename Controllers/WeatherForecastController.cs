...
namespace ProjetoInicial.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public WeatherForecastController(ILifecycleService service, Lifecycle2Services service2, ILifecycleTransientService transientService, Lifecycle2TransientService transientService2)
        {
            _service = service;
            _service2 = service2;
